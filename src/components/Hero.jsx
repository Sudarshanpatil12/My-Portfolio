    ...
    <div id="about" className="relative isolate pt-32 pb-24 px-6 sm:px-16">
      ...
      >
        ...
        >
          ...
          >
            <TextWithHighlights
              text="A motivated Full Stack Developer skilled in React, Node.js, Express, and MongoDB. Passionate about problem-solving and continuous learning, I create efficient, user-friendly web applications and thrive on turning ideas into impactful digital solutions. I am committed to delivering quality work with dedication and always strive to exceed expectations."
              highlights={[
        ...
        >
          <div className="w-full md:w-4/5 mx-auto">
            <img src={profile} alt="Sudarshan Patil" className="rounded-md" />
          </div>
        </motion.div>
      </div>
    </div>
